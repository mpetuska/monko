...
internal class MonkoCollectionC<T>(
  ...
  override val source: MonkoCollection<T> = this
  private val collection: CPointer<mongoc_collection_t> =
    mongoc_client_get_collection(database.client.c, database.dbName, name)!!
